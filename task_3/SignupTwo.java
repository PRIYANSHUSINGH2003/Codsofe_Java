...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try {
            Conn c = new Conn();
            String query = "insert into signuptwo values ('"+formNo+"','"+religion_String+"','"+category_String+"','"+Income_String+"','"+Educational_String+"','"+Occupation_String+"','"+pan+"','"+aadhar+"','"+Senior+"','"+Exisiting+"');";
